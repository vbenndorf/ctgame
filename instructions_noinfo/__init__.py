...
class Player(BasePlayer):
    ...
    Inst1Q4 = models.IntegerField(label="Suppose, you expect that the other player chooses Heads. What action choice will then maximize your payoff?", choices = [[1, 'Heads'], [0, 'Tails']], widget=widgets.RadioSelectHorizontal)
    ...
    Inst2Q4 = models.IntegerField(label="If you make your decision while your screen shows a payoff percentage of 50 and the other player does not make a decision at all, you earn 250 points.", choices = [[1, 'True'], [0, 'False']], widget=widgets.RadioSelectHorizontal)
