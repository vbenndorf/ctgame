...
class RoundSummary(Page):
    ...
    def vars_for_template(player):
        ...
        if player.move_in_beginning:
            ...
            time = max(0,player.time_of_move - 5000)
        return dict(
            move=move,
            op_move=op_move,
            time=time/1000,
...
page_sequence = [BlockStart,ResultsWaitPage,Choice_static, WaitPage1, RoundSummary, ResultsWaitPage, ResultsSummary]
